...
public class AppAsync {
	...
	public static void main(String[] args) throws IOException {
		...
		var futures=Files.lines(Path.of("url.txt"))
				.map(AppAsync::validateLink).collect(Collectors.toList());
	...
	private static CompletableFuture<String> validateLink(String link) {
		...
		return client.sendAsync(request, HttpResponse.BodyHandlers.discarding()).thenApply(AppAsync::responseTostring)
